...
//                print(ModelData().instrumentsData[id].name)
                print(ModelData().instrumentsData[id].isClicked)
                tappedInstrument += 1
            }
//            print("\nCOMPONENT\n\(id)\n\($instrument)\n")
...
//            print("current id \(id)")
        ...
        .fullScreenCover(isPresented: $isPresented, content: {
            InstrumentDetailInfoView(instrument: $instrument, id: id)
        })
    }
}
...
struct InstrumentComponent_Previews: PreviewProvider {
    ...
    static var previews: some View {
        ...
        InstrumentComponent(tappedInstrument: .constant(0), isPresented: .constant(false), instrument: .constant(instruments[0]), id: 2)
